      ...
      <section className="p-6 dark:bg-gray-100 dark:text-gray-800">
        <div className="container grid gap-6 mx-auto text-center grid-cols-1 lg:grid-cols-2 xl:grid-cols-5">
          <div className="w-full px-6 pt-16 rounded-md sm:px-12 md:px-16 xl:col-span-2 dark:bg-gray-50">
            ...
            <h1
              className="text-2xl md:text-6xl fontBricolage font-extrabold dark:text-gray-700 animate__animated animate__heartBeat"
              style={{ animationDuration: "5s" }}
            >
              {pet.serviceName}
            </h1>
            ...
            <div className="border-2 border-[#F8721F] rounded-xl space-y-2">
              <p className="text-lg md:text-3xl font-bold fontBricolage">Provider</p>
              <h2 className="flex justify-center items-center gap-1 text-base md:text-xl">
                <BiSolidRename  md:size={25} color="#F8721F" /> {pet.providerName}{" "}
              </h2>
              <h2 className="flex justify-center items-center gap-1 text-base md:text-xl">
                <MdOutlineMailLock md:size={25} color="#F8721F" />{" "}
                {pet.providerEmail}{" "}
              </h2>
            </div>
            <div className="flex justify-between my-5">
              <span className="bg-[#f8721fd7] group-hover:bg-[#f8721fd0] px-2 py-1 rounded-lg text-white font-medium md:font-semibold">
                Rating - {pet.rating}{" "}
              </span>
              <span className="bg-[#f8721fd7] group-hover:bg-[#f8721fd0] px-2 py-1 rounded-lg text-white font-medium md:font-semibold">
                Price - {pet.price}{" "}
          ...
          <img
            src={pet.image}
            alt=""
            className="object-cover w-full  md:h-[700px] rounded-md xl:col-span-3 dark:bg-gray-500"
          />
        </div>
        <div>
          <h2
            className="text-center my-10 text-3xl md:text-7xl font-bold fontPacifico text-[#F8721F] animate__animated animate__flip"
            style={{ animationDuration: "5s" }}
          >
            Paw-sitively Book!
          </h2>
          <form
            ...
            className="self-stretch space-y-3 md:w-3/6 mx-auto"
          >
            <div>
